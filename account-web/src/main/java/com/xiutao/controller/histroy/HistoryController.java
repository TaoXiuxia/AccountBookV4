package com.xiutao.controller.histroy;
...
public class HistoryController {
	...
	public @ResponseBody
    Map<String, Object> searchChartStatistics(Model model, HttpSession session, String startdate, String enddate) {
	...
	public @ResponseBody
    Map<String, Object> searchHistory(HttpSession session, Model model, String type, int year, int month, String keyword, String sortBy, int curPage) {
		Map<String, Object> map = new HashMap<String, Object>();
